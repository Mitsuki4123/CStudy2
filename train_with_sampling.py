...
def transformer(dataloader, EPOCH, k, frequency, path_to_save_model, path_to_save_loss, path_to_save_predictions, device):
    ...
    for epoch in range(EPOCH + 1):
        ...
        if epoch % 10 == 0: # Plot 1-Step Predictions
            ...
            sampled_src_y = scaler.inverse_transform(sampled_src[1:,:,0].cpu()) 
            ...
            plot_training_3(epoch, path_to_save_predictions, src_x, sampled_src_x, prediction_x, sensor_number, index_in, index_tar, src_y, sampled_src_y, prediction_y)
